...
const FacebookLink = 'https://www.facebook.com/keket13';
const LinkedinLink = 'https://www.instagram.com/keth.elden/';
const GithubLink = 'https://github.com/keket13';
        ...
        <nav class="mx-auto max-w-screen-xl px-12 py-4">
            <div class="flex flex-row items-center justify-between">
                <router-link to="/" class="flex flex-col">
                    <h1 class="font-bold text-xl">Keth Elden Mondejar</h1>
                ...
                <div class="hidden lg:block">
                    <ul class="flex flex-row gap-8">
                        <li
                            :class="$route.name === 'home' ? 'text-orange-600 font-medium text-lg' : 'text-gray-700 hover:text-orange-600 font-normal text-lg'">
                            <router-link to="/">Home</router-link>
                        </li>
                        <li
                            :class="$route.name === 'about' ? 'text-orange-600 font-medium text-lg' : 'text-gray-700 hover:text-orange-600 font-normal text-lg'">
                            <router-link to="/about">About</router-link>
                        </li>
                        <li
                            :class="$route.name === 'projects' ? 'text-orange-600 font-medium text-lg' : 'text-gray-700 hover:text-orange-600 font-normal text-lg'">
                            <router-link to="/projects">Projects</router-link>
                        </li>
                        <li
                            :class="$route.name === 'contact' ? 'text-orange-600 font-medium text-lg' : 'text-gray-700 hover:text-orange-600 font-normal text-lg'">
                ...
                <div class="hidden lg:block">
                    <ul class="flex flex-row items-center gap-3">
                        ...
                        <a :href="LinkedinLink" target="_blank" class="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <svg class="w-[20px] h-[20px] text-gray-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2476 2476" id="instagram">
                            <path 
            ...
            <div v-if="isOpenMenu" class="flex lg:hidden relative">
                ...
                <div class="bg-white flex flex-col absolute top-[18px] -left-[52px] w-screen gap-4 shadow-lg p-6 rounded">
                    <router-link to="/"
                        :class="$route.name === 'home' ? 'bg-gray-50 p-2 rounded text-orange-600 font-medium text-lg' : 'hover:bg-gray-50 p-2 text-gray-700 hover:text-orange-600 font-normal text-lg'">
                        Home
                    </router-link>
                    <router-link to="/about"
                        :class="$route.name === 'about' ? 'bg-gray-50 p-2 rounded text-orange-600 font-medium text-lg' : 'hover:bg-gray-50 p-2 text-gray-700 hover:text-orange-600 font-normal text-lg'">
                        About
                    </router-link>
                    <router-link to="/projects"
                        :class="$route.name === 'projects' ? 'bg-gray-50 p-2 rounded text-orange-600 font-medium text-lg' : 'hover:bg-gray-50 p-2 text-gray-700 hover:text-orange-600 font-normal text-lg'">
                        Projects
                    </router-link>
                    <router-link to="/contact"
                        :class="$route.name === 'contact' ? 'bg-gray-50 p-2 rounded text-orange-600 font-medium text-lg' : 'hover:bg-gray-50 p-2 text-gray-700 hover:text-orange-600 font-normal text-lg'">
                        Contact
                    </router-link>
