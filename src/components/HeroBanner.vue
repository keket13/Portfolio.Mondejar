    ...
    <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row py-16">
        ...
        <div class="flex flex-col justify-between xl:w-5/12">
            ...
            <div class="sm:text-center lg:py-12 lg:text-left xl:py-24">
                <p class="mb-4 font-semibold text-gray-600 md:mb-6 md:text-lg xl:text-xl">Hi my Name is</p>

                <h1 class="mb-8 text-4xl font-bold text-orange-500 sm:text-5xl md:mb-12">Keth Elden Mondejar.</h1>

                <h1 class="mb-8 text-4xl text-orange-400 md:mb-12">Im an IT student from Cordova Public College. This is my Portfolio.</h1>

                <div class="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start">
                    <router-link to="/about" href="#"
                        class="inline-block rounded-lg bg-orange-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none 
                        ring-indigo-300 transition duration-100 hover:bg-orange-400 focus-visible:ring active:bg-orange-500 md:text-base">
                        About Me
                    </router-link>
            ...
            <div class="mt-8 flex items-center justify-center gap-4 sm:mt-16 lg:justify-start">
                ...
                <div class="flex gap-4">
                    ...
                    <a :href="LinkedinLink" target="_blank"
                        class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2476 2476" id="instagram">
                            <path 
